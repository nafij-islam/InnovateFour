...
import bannerbrand1 from "../../assets/bannerbrand1.png";
import bannerbrand2 from "../../assets/bannerbrand2.png";
import bannerbrand3 from "../../assets/bannerbrand3.png";
import bannerbrand4 from "../../assets/bannerbrand4.png";
import "./banner.css";
      ...
      >
        <div className="max-w-[1320px] mx-auto">
          <div className="text-center textmaindiv  md:pt-[100px] sm:pt-[200px] lg:pt-[200px] lg:pb-[0px]">
            ...
            <p className="text-white w-auto text-[18px] pb-[48px] leading-[200%] mx-auto font-normal lg:w-[750px]">
            ...
            <div className="lg:block md:block sm:block justify-center flex">
              ...
              />
              <button className="lg:py-[30px] text-white md:py-[25] sm:py-[30px] rounded-r-[15px] px-4 md:px-[25px] sm:px-[25px] lg:px-[30px] bg-[#6A55EA]">
                Analyze website
              </button>
            </div>
          </div>
        ...
        <div className="sm:hidden banall xs:hidden md:hidden lg:block relative">
          ...
          <img
            className="w-full animaone absolute top-0 left-0 bg-cover bg-no-repeat"
            src={ban2}
            alt=""
          />
          <img
            className="w-full animatwo absolute top-30 left-0 bg-cover bg-no-repeat"
            src={ban3}
            alt=""
          />
          <img
            className="w-[300px] rocket absolute top-[-300px] right-0 bg-cover bg-no-repeat"
            src={ban4}
            alt=""
          />
          <img
            className="w-[150px] roundani  absolute top-[-460px] opacity-20 left-50  bg-cover bg-no-repeat"
            src={ban5}
            alt=""
          />
        </div>
