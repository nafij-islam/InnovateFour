    ...
    <section className="lg:py-10 md:py-10 py-8 px-2">
      <div className="max-w-[1320px] mx-auto">
        <div>
          ...
          <h2 className="text-[#29313D] leading-[140%] md:w-[500px] sm:w-[400px]  lg:pb-[60px] text-[30px] sm:text-[40px] md:text-[40px] lg:text-[48px] lg:w-[600px] mx-auto font-semibold text-center">
        ...
        <div className="flex justify-between flex-wrap">
          <div className="lg:w-[48%] md:w-full">
            <div> 
              <p className="text-[17px] lg:text-start lg:w-full pt-5 lg:pt-[37px] sm:w-[600px]  mx-auto sm:mx-auto md:w-[700px] md:mx-auto   font-normal text-center leading-[200%] sm:pb-5 pb-4 md:pb-10 lg:pb-[90px]">
                With over 25 years of experience, we have cra fted thousands of
