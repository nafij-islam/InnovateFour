    ...
    <section className='py-[120px]'>
        <div className='max-w-[1320px] mx-auto'>
            <div className='flex items-center px-3 pb-10 lg:pb-0 sm:pb-10 justify-between'>
                ...
                <button className='border-1 py-[20px] px-[30px] rounded-[14px] text-[18px] font-semibold hover:text-white duration-300 hover:bg-[#6A55EA] border-black '>View all</button>
                </div>
            </div>

            <div className='lg:flex  lg:ml-0 md:ml-0 sm:ml-50  lg:justify-between  md:flex px-2  sm:gap-10  md:gap-8 md:justify-between'>
                <div className='lg:w-[30%] md:w-[48%] w-[62%]'>
                 ...
                 <div className='lg:w-[30%] md:mx-auto  lg:mx-0 md:w-[48%] w-[62%]'>
