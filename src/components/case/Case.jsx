        ...
        <div className='max-w-[1320px] mx-auto'>
            <div className='flex items-center px-3 pb-10 lg:pb-0 sm:pb-10 justify-between'>
                <div className='lg:pb-[60px]'>
                    <h4 className='text-[#7968EF] lg:pb-[14px]'>Our works</h4>
                    <h3 className='text-[40px] lg:text-[48px] font-semibold'>Our case </h3>
                </div>
                <div>
            ...
            <div className='lg:flex  lg:ml-0 md:ml-0  lg:justify-between  md:flex px-2  sm:gap-10  md:gap-8 md:justify-between'>
                <div className='lg:w-[30%] pb-4 md:w-[48%] sm:w-full w-full'>
                 ...
                 <div className='lg:w-[30%] pb-4 md:mx-auto  sm:w-full lg:mx-0 md:w-[48%] w-full'>
